...
class __TwigTemplate_472b6a493d63c0596b6c308ad149430a extends Template
{
    private $source;
    private $macros = [];
    ...
    <div class=\"home\">
        ...
        $context['_seq'] = twig_ensure_traversable((isset($context["offres"]) || array_key_exists("offres", $context) ? $context["offres"] : (function () { throw new RuntimeError('Variable "offres" does not exist.', 9, $this->source); })()));
        $context['loop'] = [
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["offre"]) {
            // line 10
            echo "                ";
            echo twig_include($this->env, $context, "partials/_offre_item.html.twig", ["item" => $context["offre"]]);
            echo "
            ";
            ++$context['loop']['index0'];
            ++$context['loop']['index'];
...
";
    ...
    {
        return array (  139 => 16,  134 => 14,  130 => 13,  127 => 12,  110 => 10,  93 => 9,  88 => 6,  78 => 5,  59 => 3,  36 => 1,);
    }
...
{% block content %}
    ...
    <div class=\"home\">
        <div class=\"offres\">
            {% for offre in offres %}
                {{ include('partials/_offre_item.html.twig', {item: offre}) }}
            {% endfor %}
        </div>
        {{ form_start(form) }}
        {{ form_rest(form) }}
...
{% endblock %}
", "index/index.html.twig", "C:\\Users\\hassa\\OneDrive\\Bureau\\symfony_learn\\templates\\index\\index.html.twig");
    }
}
